const miBoton = document.getElementById("btn-modo");
const miBoton = document.getElementById("form-contacto");
const miBoton = document.getElementById("mensaje-confirmacion");
